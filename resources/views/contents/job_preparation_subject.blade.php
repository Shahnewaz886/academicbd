                            ...
                            <ul>
                                <li class="innermenu">
                                    <div class="parent-menu">
                                        ...
                                        <span class="{{ (Request::segment(1)=='job-preparation')?'parent-menu-active':'parent-menu-hover' }}"><i class="icofont  icofont-curved-right"></i></span>
                                    </div>
                                </li>
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            $("body").on( "click", ".material_type_title", function() {
                ...
                var job_exam_id = '{{ Request::segment(2) }}';
                ...
                $.ajax({
                    ...
                    dataType: 'HTML',
                    data: {job_exam_id:job_exam_id,subject_id:subject_id,material_type_id:material_type_id,content_section_id:12},
                    success: function( data ) {
